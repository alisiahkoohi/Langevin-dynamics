...
if __name__ == '__main__':
    ...
    max_itr = int(1e4)
    mala = MetropolisAdjustedLangevin(x, banana_dist.nl_pdf, 
        lr=1e0, lr_final=9e-1, max_itr=max_itr, device=device)
    ...
    plt.tight_layout()
    # plt.savefig('figs/banana-MALA.png', format="png", bbox_inches="tight", dpi=300)
    plt.show()